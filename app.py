...
st.write('This ML-based app is developed for educational purposes.'
         'Objective of the app is detecting phishing websites only using content data.'
         'Not URL!'
         'You can see the details of approach, data set, and features and results if'
...
st.write('I used only content-based features. I didn\'t use url-based faetures'
         'like length of url etc.'
...
st.write('I used 7 different ML classifiers of scikit-learn and tested them'
         ...
         'Firstly obtained their confusion matrices, then calculated their'
